...
const MILESTONES = [
  ...
  { year: '2020', event: 'Surpassed 12,000 clients — launched same-day service guarantee' },
...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>About Us | A to Z Pest Solutions — Pest Control Bangalore Since 1993</title>
        <meta name="description" content="Learn about A to Z Pest Solutions — Bangalore's trusted pest control company since 1993. Our certified experts deliver eco-friendly, safe, and guaranteed pest management for homes and businesses." />
        <link rel="canonical" href="https://pestcontrolbengaluru.in/about-us" />
      </Helmet>
