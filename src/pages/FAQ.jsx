...
const FAQ_DATA = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Do you provide a pest control service warranty?', a: 'Warranty availability depends on the specific pest control service selected. Certain treatments may include a service warranty or follow-up visit. Our team will explain the applicable warranty terms before beginning the work.' },
