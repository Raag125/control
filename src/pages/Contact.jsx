...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true)
    // Simulate form submission — replace with actual API/EmailJS integration
    setTimeout(() => {
      setLoading(false)
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | A to Z Pest Solutions – Pest Control Bangalore</title>
        <meta name="description" content="Contact A to Z Pest Solutions for pest control in Bangalore. Call 9845559710, WhatsApp us, or fill the form for a FREE inspection. Available 24/7, 365 days." />
        <link rel="canonical" href="https://pestcontrolbengaluru.in/contact" />
      </Helmet>
          ...
          <div className="container">
            ...
            <div className="contact-grid">
              ...
              >
                ...
                <p style={{ fontSize: '0.85rem', color: 'var(--clr-text-muted)', marginBottom: '1.75rem' }}>
                ...
                <form onSubmit={handleSubmit} noValidate aria-label="Pest control booking form">
                  ...
                  <p style={{ fontSize: '0.75rem', color: 'var(--clr-text-dim)', marginTop: '0.75rem', textAlign: 'center' }}>
