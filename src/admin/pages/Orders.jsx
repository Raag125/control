  ...
  return (
    <div>
      ...
      <div className="adm-section-header">
        <div>
          <h1 className="adm-section-title">📋 Customer Orders</h1>
                ...
                {filtered.length === 0
                  ...
                  : filtered.map(o => (
                    <tr key={o.id}>
                      ...
                      <td>{o.service}</td>
                      <td>{o.area || '—'}</td>
                      <td style={{ color: 'var(--a-muted)' }}>{o.date}<br/>{o.time}</td>
          ...
          <div className="adm-mobile-list">
            {filtered.map(o => (
              <div key={o.id} className="adm-mobile-card">
                ...
                {o.address && (
                  <div style={{ color: 'var(--a-muted)', background: 'var(--a-card2)', padding: '.35rem .6rem', borderRadius: '6px', border: '1px solid var(--a-border)' }}>
                    📍 {o.address}
                  </div>
                )}
        ...
        <ModalPortal>
          <div className="adm-modal-overlay">
            <div className="adm-modal" style={{ maxWidth: 360 }}>
              ...
              <p style={{ color: 'var(--a-muted)', marginBottom: '1.25rem' }}>This action cannot be undone.</p>
