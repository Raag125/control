...
export default function TermiteTreatment() {
  return <ServiceDetailPage
    meta={{ title: 'Termite Treatment in Bangalore | A to Z Pest Solutions', desc: 'Expert anti-termite treatment in Bangalore. Drill-fill-seal soil treatment, wood protection & pre/post-construction solutions. Professional anti-termite treatment. Call 9845559710 for FREE inspection.' }}
    ...
    benefits={['CIB-registered, WHO-approved termiticide formulations','Drill-Fill-Seal (DFS) method for 100% barrier coverage','post-construction Drill-Fill-Seal treatment','pre-construction soil treatment protection','Zero disruption — no need to vacate the property','Odorless, non-staining treatment — safe for family and pets','Certified & trained PCAI member technicians','Free follow-up inspection visits included']}
    process={[
      ...
      { title: 'Post-Treatment Certification & Report', desc: 'A documented treatment report and official service certificate is issued. We schedule free follow-up visits to confirm barrier integrity.' },
    ]}
    faqs={[
      ...
      { q: "How long does service support last?", a: "Our post-construction Drill-Fill-Seal treatment includes free re-treatment visits if termites return. Pre-construction soil treatment provides long-term barrier protection." },
      ...
      { q: "Can termites come back after treatment?", a: "Re-infestation is extremely rare after proper treatment due to the continuous chemical barrier. If termite activity is detected, we re-treat free of charge." },
