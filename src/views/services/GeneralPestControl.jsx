...
export default function GeneralPestControl() {
  return <ServiceDetailPage
    meta={{ title: 'General Pest Control in Bangalore | A to Z Pest Solutions', desc: 'General pest control services in Bangalore. Keep your space free from cockroaches, ants, spiders, and silverfish. Professional & eco-friendly solutions.' }}
    ...
    benefits={['Eliminates pests at their source','Safe, eco-friendly, and odorless chemicals','Protects family health from allergens and diseases','Cost-effective preventive maintenance','Convenient service with minimal disruption','Professional results for peace of mind']}
    process={[
