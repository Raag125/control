...
export default function CommercialPestControl() {
  return <ServiceDetailPage
    meta={{ title: 'Commercial Pest Control in Bangalore | A to Z Pest Solutions', desc: 'Reliable commercial pest control for offices, restaurants, and warehouses in Bangalore. Ensure compliance and protect your business reputation.' }}
