...
export default function Franchise() {
  const [form, setForm] = useState({ name: '', phone: '+91 ', email: '', city: '', message: '' })
  ...
  const handleSubmit = (e) => {
    ...
    if (!form.name || phoneDigits.length < 12) {
              ...
              <form onSubmit={handleSubmit} noValidate aria-label="Franchise application form">
                <div className="form-row">
                  ...
                  <div className="form-group">
                    ...
                    <input id="fr-phone" name="phone" type="tel" className="form-input" placeholder="+91 98455 59710" value={form.phone} onChange={handlePhoneChange} required aria-required="true" maxLength={15} />
                  </div>
                </div>
                <div className="form-row">
                  <div className="form-group">
